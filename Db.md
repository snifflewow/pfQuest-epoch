...
This document outlines the structure of the database files, detailing the purpose, format, and an example for each file.
...
["flight"] = {
  [UNITID#] = "FACTIONLETTER", -- Unit ID of the flight path NPC and A, H, or AH for faction.
...
[UNITID#] = {
  ...
  ["fac"] = "faction", -- A (Alliance), H (Horde), AH (both)
  ["lvl"] = "level",
},
```
